...
先读取当前对话，以及与问题直接相关的工件：`STRATEGY-MAP.md`、`MISSION.md`、`LEARNING-SOP.md`、`TASKS.md`、`LEARNER-PROFILE.md`、`learning-models/`、课程工件、`learning-records/` 或 `reviews/`。没有足够语境时，只问一个能决定下一步的问题。
...
| 围绕真实问题开展跨会话教学，根据理解边缘选课并以本课目标控制停止 | `/teach-me` | `LEARNER-PROFILE.md`、含本课目标的课程、可直达电子书具体页的参考链接与学习证据 |
